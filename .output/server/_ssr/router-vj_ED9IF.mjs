...
import { A as toResponse, B as array, C as defineRequestState, Cn as isDevelopment, D as runWithEndpointContext, Dn as BetterAuthError, E as getCurrentAuthContext, En as APIError, F as createLocalAccountIssuer, G as number, H as email, I as createOAuthAccountIssuer, J as record, K as object, L as boolean, M as filterOutputFields, N as userSchema, O as getBetterAuthVersion, On as kAPIErrorHeaderSymbol, P as sessionSchema, Q as unknown, R as string$1, S as runWithTransaction, T as runWithRequestState, Tn as isTest, U as literal, V as boolean$1, Vt as JWTExpired, W as looseObject, X as string, Y as strictObject, Z as union, _ as createAuthMiddleware, _n as logger, an as import_src, b as queueAfterTransactionHook, bn as env, c as mergeScopes, cn as getAuthTablesWithResolvedIndexes, d as findInvalidTrustedProxies, dn as getPortableDatabaseIdentifierKey, et as base64Url, f as getIP, fn as initGetModelName, g as createAuthEndpoint, gn as createLogger, h as normalizePathname, hn as createRandomStringGenerator, i as verifyProviderIdToken, in as ATTR_OPERATION_ID, j as serializeCookie, k as createRouter$1, kn as BASE_ERROR_CODES, kt as encode, l as isLoopbackHost, ln as getDatabaseFieldIndexName, mn as generateId, n as socialProviders, nn as ATTR_CONTEXT, nt as jwtVerify, on as safeJSONParse, p as deprecate, pn as initGetFieldName, q as optional, r as supportsIdTokenSignIn, rn as ATTR_HOOK_TYPE, s as additionalAuthorizationParamsSchema, sn as getAuthTables, t as SocialProviderListEnum, tn as withSpan, tt as decodeProtectedHeader, u as createRateLimitKey, un as getDatabaseIndexStringLength, v as isAPIError, vn as shouldPublishLog, w as hasRequestState, wn as isProduction, x as runWithAdapter, y as getCurrentAdapter, z as any } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-vj_ED9IF.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-DkNf7UKy.css";
...
var $$splitComponentImporter$1 = () => import("./routes-CewPMDq2.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-D24wB4Ha.mjs");
...
var signInEmail = () => createAuthEndpoint("/sign-in/email", {
	...
	const userRecord = await ctx.context.internalAdapter.findUserByEmail(email$1.toLowerCase(), { includeAccounts: true });
...
//#endregion
export { getBaseURL as n, router_exports as t };
