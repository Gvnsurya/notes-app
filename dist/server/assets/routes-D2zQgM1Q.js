...
function NotesPage() {
	...
	if (!session && !loading) return /* @__PURE__ */ jsx("main", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("h1", { children: "Welcome to My Notes" }),
				/* @__PURE__ */ jsx("p", { children: "Please log in to access your notes." }),
				/* @__PURE__ */ jsx("button", {
	...
	return /* @__PURE__ */ jsxs("main", {
		className: "notes-page",
		children: [
			/* @__PURE__ */ jsx("div", { className: "background-orb orb-1" }),
			/* @__PURE__ */ jsx("div", { className: "background-orb orb-2" }),
			/* @__PURE__ */ jsx("div", { className: "background-orb orb-3" }),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("header", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: "✦"
							}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", { children: "My Notes" }), /* @__PURE__ */ jsx("p", { children: "Organize your thoughts beautifully" })] })]
						}), /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: [/* @__PURE__ */ jsx("span", { children: "Welcome" }), /* @__PURE__ */ jsx("strong", { children: session?.user?.name || "User" })]
								})]
							}), /* @__PURE__ */ jsx("button", {
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							}), /* @__PURE__ */ jsx("h2", { children: editingId ? "Update your thought" : "What's on your mind?" })] }), /* @__PURE__ */ jsx("div", {
								className: "form-icon",
								children: editingId ? "✎" : "+"
							})]
						}), /* @__PURE__ */ jsxs("form", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									className: "input-group",
									children: [/* @__PURE__ */ jsx("label", { children: "Content" }), /* @__PURE__ */ jsx("textarea", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [editingId && /* @__PURE__ */ jsx("button", {
											type: "button",
											...
											type: "submit",
											className: "primary-btn",
											children: [editingId ? "Update Note" : "Add Note", /* @__PURE__ */ jsx("span", { children: "→" })]
										})]
									})]
								})
							]
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							}), /* @__PURE__ */ jsx("h2", { children: "Your Notes" })] }), !loading && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", { className: "loader" }), /* @__PURE__ */ jsx("p", { children: "Loading your notes..." })]
						}) : filteredNotes.length === 0 ? /* @__PURE__ */ jsxs("div", {
							className: "empty-state",
							children: [
								/* @__PURE__ */ jsx("div", {
								...
								/* @__PURE__ */ jsx("h3", { children: "No notes found" }),
								/* @__PURE__ */ jsx("p", { children: searchQuery ? "Try a different search." : activeFilter !== "ALL" ? "There are no notes in this category yet." : "Create your first note and keep your ideas organized." })
							]
						}) : /* @__PURE__ */ jsx("div", {
							className: "notes-grid",
							children: filteredNotes.map((note) => /* @__PURE__ */ jsxs("article", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("h3", { children: note.title }),
									/* @__PURE__ */ jsx("p", { children: note.content }),
									/* @__PURE__ */ jsx("div", {
										className: "note-card-footer",
										children: /* @__PURE__ */ jsx("span", { children: note.isPinned ? "📌 Pinned note" : "✦ Saved note" })
									})
								]
							}, note.id))
						})]
