...
import { createLocalAccountIssuer, createOAuthAccountIssuer, getAuthTables, sessionSchema, userSchema } from "@better-auth/core/db";
import { filterOutputFields } from "@better-auth/core/utils/db";
import { safeJSONParse } from "@better-auth/core/utils/json";
import * as z from "zod";
import { createRouter as createRouter$1, kAPIErrorHeaderSymbol, serializeCookie, toResponse } from "better-call";
...
import { additionalAuthorizationParamsSchema, mergeScopes, supportsIdTokenSignIn, verifyProviderIdToken } from "@better-auth/core/oauth2";
import { SocialProviderListEnum, socialProviders } from "@better-auth/core/social-providers";
import { getAuthTablesWithResolvedIndexes, getDatabaseFieldIndexName, getDatabaseIndexStringLength, getPortableDatabaseIdentifierKey } from "@better-auth/core/db/internal";
...
var cookieCachePayloadSchema = z.looseObject({
	session: sessionSchema.loose(),
	user: userSchema.loose(),
	updatedAt: z.number(),
	version: z.string().optional()
});
var compactCookieCacheSchema = z.object({
...
var accountSelectionSchema = z.union([z.strictObject({
...
var signOutBodySchema = z.object({
...
//#endregion
export { getRouter, getBaseURL as n, router_exports as t };
